...
3. **Log in to Container Registry**: Logs in to the GitHub Container Registry using a personal access token [GH\_PAT](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens).
