...
- **PNPM**: [ˆ11](https://pnpm.io/installation)
...
- **Azure Storage Account**: To test functionality
...
Refer to the [website documentation](./website/index.md) for its configuration.
